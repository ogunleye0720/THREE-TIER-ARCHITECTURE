...
|[aws_sns_topic](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Cloudwatch_Alarm/main.tf?plain=1#L2-5) | Creates SNS Topic For CPU-Usage Notification | us-east-1 | Optional |
|[aws_sns_topic_subscription](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Cloudwatch_Alarm/main.tf?plain=1#L8-13) | Creates SNS Subscription For CPU-Usage Notification | us-east-1 | Optional |
...
|[aws_autoscaling_attachment](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Compute/main.tf?plain=1#L119-130) | Attaches The EC2 Instance To An AWS Auto Scaling Group (ASG) | us-east-1 | YES |
|[aws_kms_key](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/KMS/main.tf?plain=1#L4-12) | Enables Creation And Control Of Encryption Keys Used To Encrypt And Decrypt Data In The RDS Instance Storage| us-east-1 | Optional |
|[aws_kms_key_policy](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/KMS/main.tf?plain=1#L19-38) | Grants Permission To The kms key And User | us-east-1 | Optional |
|[Load-Balancer](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Load-Balancer/main.tf) | Creates Load-Balancers, Load-Balancer Listeners, Listener Rules, And Load-Balancer Target Group For The Presentation Layer and Application Layer | us-east-1 | YES |
|[aws_vpc](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Network/main.tf?plain=1#L9-18) | Creates A Private Isolated Network In The AWS Cloud For Launching All The Resources Required To Build The Three-Tier-Architecture  | us-east-1 | YES |
|[aws_subnet](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Network/main.tf?plain=1#L22-63) | Divides The IP Address Range Of The VPC Into Smaller Segments To Logically Separate Resources Within The VPC  | us-east-1 | YES |
...
|[RDS_read_replica](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/RDS_read_replica) | Creates The VPC, RDS_read_replica, And All Other Resources Required To Enable The Read_replica Function Efficiently   | us-west-2 | Optional |
|[aws_route53_zone](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Route_53/main.tf?plain=1#L1-4) |  AWS's Domain Name System (DNS) Web Service That Enables Management And Routing Of Traffic For Domain Names   | us-east-1 | YES |
