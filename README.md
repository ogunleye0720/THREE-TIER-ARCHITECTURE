...
|[aws_kms_key](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/KMS/main.tf?plain=1#L4-12) | enables you to Creation And Control Of Encryption Keys Used To Encrypt And Decrypt Data In The RDS Instance Storage| us-east-1 | Optional |
...
|[Load-Balancer](https://github.com/ogunleye0720/THREE-TIER-ARCHITECTURE/blob/master/modules/Load-Balancer/main.tf) | Creates Load-Balancers, Load-Balancer Listenrs, Listener Rules, And Load-Balancer Target Group For The Presentation Layer and Application Layer | us-east-1 | YES |
